...
export default function BodyRecordUpdateForm(props) {
  const {
    id: idProp,
    bodyRecord: bodyRecordModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = bodyRecordRecord
      ? { ...initialValues, ...bodyRecordRecord }
      : initialValues;
  ...
  const [bodyRecordRecord, setBodyRecordRecord] =
    React.useState(bodyRecordModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(BodyRecord, idProp)
        : bodyRecordModelProp;
      setBodyRecordRecord(record);
    };
    queryData();
  }, [idProp, bodyRecordModelProp]);
  React.useEffect(resetStateValues, [bodyRecordRecord]);
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            BodyRecord.copyOf(bodyRecordRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "BodyRecordUpdateForm")}
      {...rest}
    >
      <TextField
        label="Height"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || bodyRecordModelProp)}
